...
export default function HomeScreen() {
  ...
  const handleLike = (postId: string) => {
    // Don't 'await' here unless you want to do something specific after success
    likePost(postId).catch((err) => console.log("Like failed", err));
  };

  const handleDislike = (postId: string) => {
    dislikePost(postId).catch((err) => console.log("Dislike failed", err));
  };
      ...
      <FlatList
        ...
        ListFooterComponent={
          <View style={styles.endSection}>
            <Text style={styles.endTextBig}>
              MADE WITH LOVE <Ionicons name="heart" size={52} color="red" />
            </Text>
